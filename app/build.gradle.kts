...
android {
  namespace = "com.reefii.aeromute"
  compileSdk { version = release(36) { minorApiLevel = 1 } }

  defaultConfig {
    applicationId = "com.reefii.aeromute"
    minSdk = 24
    targetSdk = 36
    versionCode = 1
    versionName = "1.0"
  ...
  signingConfigs {
    create("release") {
      ...
      keyAlias = System.getenv("KEY_ALIAS") ?: (if (keystore.name == "debug.keystore") "androiddebugkey" else "upload")
